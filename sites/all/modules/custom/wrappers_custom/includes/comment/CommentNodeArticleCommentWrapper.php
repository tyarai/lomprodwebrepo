...
/**
 * @file
 * class CommentNodeArticleCommentWrapper
 */

class CommentNodeArticleCommentWrapper extends WdCommentWrapper {

  protected $entity_type = 'comment';
  private static $bundle = 'comment_node_article';

  /**
   * Create a new comment_node_article comment.
   *
   * @param array $values
   * @param string $language
   * @return CommentNodeArticleCommentWrapper
   */
  public static function create($values = array(), $language = LANGUAGE_NONE) {
    $values += array('entity_type' => 'comment', 'bundle' => self::$bundle, 'type' => self::$bundle);
    $entity_wrapper = parent::create($values, $language);
    return new CommentNodeArticleCommentWrapper($entity_wrapper->value());
  }
