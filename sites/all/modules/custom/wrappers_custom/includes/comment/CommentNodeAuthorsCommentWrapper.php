...
/**
 * @file
 * class CommentNodeAuthorsCommentWrapper
 */

class CommentNodeAuthorsCommentWrapper extends WdCommentWrapper {

  protected $entity_type = 'comment';
  private static $bundle = 'comment_node_authors';

  /**
   * Create a new comment_node_authors comment.
   *
   * @param array $values
   * @param string $language
   * @return CommentNodeAuthorsCommentWrapper
   */
  public static function create($values = array(), $language = LANGUAGE_NONE) {
    $values += array('entity_type' => 'comment', 'bundle' => self::$bundle, 'type' => self::$bundle);
    $entity_wrapper = parent::create($values, $language);
    return new CommentNodeAuthorsCommentWrapper($entity_wrapper->value());
  }
